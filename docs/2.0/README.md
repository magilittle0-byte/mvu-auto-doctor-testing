...
状态：`2.0.0-rc.30-mvu-optimization-candidate / testing-main / complete-suite-and-formal-gates-pending`
...
- [`MVU_RUNTIME_SOURCE_MAP.md`](MVU_RUNTIME_SOURCE_MAP.md)：rc.29/rc.30 的宿主静态事件证据、A/B/C/D 运行时所有权、存储边界、可配置 runtime binding 与验证边界。
